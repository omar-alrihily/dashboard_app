    ...
    <>
      ...
      {!isPanelOpen && ( // Only show the burger button if the panel is closed
        <button
          ...
          className="lg:hidden mt-6 ml-3 w-7 h-7 p-2 bg-stone-300 text-black rounded shadow z-20 transition-colors"
        >
      ...
      {/* Panel */}
      <div
        className={`fixed w-1/2 lg:static inset-0 lg:inset-auto bg-stone-200 lg:bg-transparent z-10 transform transition-transform duration-300 ease-in-out ${
      ...
      >
        <div className="w-64 h-full lg:h-auto p-4 bg-stone-200 border-r border-gray-200">
          ...
          <button
            ...
            className="lg:hidden absolute top-4 right-4 p-2 bg-stone-300 text-black rounded shadow hover:bg-cyan-600 transition-colors"
          >
          ...
          <button
            ...
            className="w-full p-2 bg-stone-300 text-black rounded hover:bg-stone-400 hover:text-white focus:outline-none"
          >
            Clear Filters
          </button>
        </div>
